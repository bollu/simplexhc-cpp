...
using namespace sxhc;


Function *RuntimeDebugBuilder::getVPrintF(StgIRBuilder &Builder) {
...
Function *RuntimeDebugBuilder::getAddressSpaceCast(StgIRBuilder &Builder,
...
std::vector<Value *>
RuntimeDebugBuilder::getGPUThreadIdentifiers(StgIRBuilder &Builder) {
...
void RuntimeDebugBuilder::createPrinter(StgIRBuilder &Builder, bool IsGPU,
...
prepareValuesForPrinting(StgIRBuilder &Builder, ArrayRef<Value *> Values) {
...
void RuntimeDebugBuilder::createCPUPrinterT(StgIRBuilder &Builder,
                                            ArrayRef<Value *> Values) {
...
void RuntimeDebugBuilder::createGPUPrinterT(StgIRBuilder &Builder,
                                            ArrayRef<Value *> Values) {
  std::string str;
...
Function *RuntimeDebugBuilder::getPrintF(StgIRBuilder &Builder) {
  Module *M = Builder.GetInsertBlock()->getParent()->getParent();
...
void RuntimeDebugBuilder::createPrintF(StgIRBuilder &Builder,
                                       std::string Format,
                                       ArrayRef<Value *> Values) {
...
void RuntimeDebugBuilder::createFlush(StgIRBuilder &Builder) {
  Module *M = Builder.GetInsertBlock()->getParent()->getParent();
