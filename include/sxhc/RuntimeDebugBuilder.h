...
struct RuntimeDebugBuilder {
  ...
  static void createCPUPrinter(StgIRBuilder &Builder, Args... args) {
  ...
  ///  @param Args    The list of values to print.
  template <typename... Args>
  static void createGPUPrinter(StgIRBuilder &Builder, Args... args) {
    std::vector<llvm::Value *> Vector;
...
private:
  /// Handle Values.
  template <typename... Args>
  static void createPrinter(StgIRBuilder &Builder, bool UseGPU,
  ...
  static void createGPUPrinterT(StgIRBuilder &Builder,
                                llvm::ArrayRef<llvm::Value *> Values);

  /// Print a list of Values on a CPU.
  static void createCPUPrinterT(StgIRBuilder &Builder,
                                llvm::ArrayRef<llvm::Value *> Values);
  ...
  static llvm::Function *getPrintF(StgIRBuilder &Builder);
  ...
  static void createPrintF(StgIRBuilder &Builder, std::string Format,
                           llvm::ArrayRef<llvm::Value *> Values);

  /// Get (and possibly insert) a vprintf declaration into the module.
  static llvm::Function *getVPrintF(StgIRBuilder &Builder);

  /// Call fflush
  ///
  /// @parma Builder The builder used to insert the code.
  static void createFlush(StgIRBuilder &Builder);

  /// Get (and possibly insert) a NVIDIA address space cast call.
  static llvm::Function *getAddressSpaceCast(StgIRBuilder &Builder,
  ...
  getGPUThreadIdentifiers(StgIRBuilder &Builder);
};
} // namespace polly
